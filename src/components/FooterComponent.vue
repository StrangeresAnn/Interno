<template>
    <footer class="footer center">
        <div class="footer__left">
                <img class="footer__logo" src="@/assets/img/Logo.jpg" alt="footerLogo">
        ...
        <nav class="footer__center">
            ...
            <router-link v-for="link in links" :key="link.id" :to="link.url" class="footer__link">{{ link.title }}</router-link>
        </nav>
        <div class="footer__right">
            ...
            <p class="footer__contact footer__contact-phone">(123) 456 - 7890</p>
        </div>
    </footer>
</template>
